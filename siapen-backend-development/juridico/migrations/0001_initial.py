    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data_inicio_isolamento_preventivo",
                    models.DateField(blank=True, null=True),
                ),
                (
                    "qtd_dias_isolamento_preventivo",
                    models.IntegerField(
                        blank=True,
                        null=True,
                        validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("ADV", "Advertência Verbal"),
                            ("ISO", "Isolamento Celular"),
                            ("REP", "Repreensão"),
                            ("SUS", "Suspensão ou Restrição de Direitos"),
                        ],
                        max_length=3,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("AGU", "Aguardando Decisão"),
                            ("IMP", "Improcedente"),
                            ("PAR", "Parcialmente Procedente"),
                            ("PRO", "Procedente"),
                        ],
                        max_length=3,
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="juridico.procedimentodisciplinar",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("IND", "Indeferido"),
                            ("INC", "Incluído"),
                            ("CONA", "Conflito de Competência - Em andamento"),
                            ("CONF", "Conflito de Competência - Finalizado"),
                        ],
                        max_length=4,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="juridico.autorizadorinclusao",
                    ),
                ),
                (
                    "pessoa",
