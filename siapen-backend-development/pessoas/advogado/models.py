...
class Advogado(BaseModel):
    ...
    nacionalidade = models.ManyToManyField(Pais, default=None,
    ...
    enderecos = models.ManyToManyField(Endereco, blank=True,
                                       related_name="endereco_related")
    telefones = models.ManyToManyField(Telefone, blank=True,
                                       related_name="telefone_related")
    ...
    oabs = models.ManyToManyField(OAB, default=None,
        related_name="oab_advogado_%(app_label)s_%(class)s_related")
