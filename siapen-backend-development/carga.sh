...
python manage.py loaddata fixtures/vinculos/tipo_visitacao.json
echo "JURÍDICO"
...
echo "VISITANTE"
python manage.py loaddata fixtures/visitante/visitante.json
python manage.py loaddata fixtures/visitante/documentos_visitante.json
