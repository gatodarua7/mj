...
from prisional.views import BlocoViewSet, CelaViewSet, DefeitoCelaViewSet, DefeitoViewSet, \
    DesignacaoFuncaoServidorViewSet, ReparoCelaViewSet, SistemaPenalViewSet, UnidadeViewSet, \
    PrisionalViewSet, UsuarioSistemaViewSet
