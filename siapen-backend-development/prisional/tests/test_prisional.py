...
class TestPrisionalEndpoint(SiapenTestCase):
    ...
    def list_bloco(self, id=None):
        ...
        """
        url = f'/api/prisional/bloco-alocacao/' if not id else f'/api/prisional/treeview-bloco/{id}'
    ...
    def list_cela(self, id=None):
        ...
        Efetua a listagem de dados da API.
        """
        url = f'/api/prisional/cela-alocacao/' if not id else f'/api/prisional/treeview-cela/{id}'
        response = self.client.get(url, follow=True)
        return response
    ...
    def list_setor(self, id=None):
        ...
        Efetua a listagem de dados da API.
        """
        url = f'/api/prisional/setor-alocacao/' if not id else f'/api/prisional/treeview-setor/{id}'
        response = self.client.get(url, follow=True)
        return response
