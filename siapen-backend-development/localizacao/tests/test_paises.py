...
from localizacao.models import Pais
from django.contrib.auth.models import User
from util import mensagens


class TestPaisEndpoint(SiapenTestCase):
    def setUp(self) -> None:
        self.entidade = "Paises"
        self.data = {"nome": "TESTE", "sigla": "TT"}
        self.url = f"/api/localizacao/paises/"
        super(TestPaisEndpoint, self).setUp()
