...
from social.views import EstadoCivilViewSet, GrauDeInstrucaoViewSet, NecessidadeEspecialViewSet, \
    OrientacaoSexualViewSet, ProfissaoViewSet, RacaViewSet, ReligiaoViewSet
