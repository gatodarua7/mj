...
class TestRacaEndpoint(SiapenTestCase):
    ...
    def setUp(self) -> None:
        self.entidade = "RAÇA"
        self.data = {"nome": "RAÇA TESTE", "ativo": True}
        self.url = f"/api/social/raca/"
        super(TestRacaEndpoint, self).setUp()
    ...
    def test_c_delete(self):
        ...
        """
        url = f"{self.base_url+self.url}55ba36bb-b8cd-4245-8e42-58f952ff31fc/"
