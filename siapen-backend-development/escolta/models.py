...
class Escoltas(BaseModel):
    ...
    descricao_aerea = models.TextField(max_length=500, default=None, null=True, blank=True)
    fase_escolta_aerea = models.CharField(max_length=20, choices=FasesEscolta.choices, default=None, null=True, blank=True)
    servidores_escolta_aerea = models.ManyToManyField(Servidor,
                                                        blank=True,
                                                        default=None,
    ...
    descricao_terrestre = models.TextField(max_length=500, default=None, null=True, blank=True)
    servidores_escolta_terrestre = models.ManyToManyField(Servidor,
                                                    blank=True,
                                                    default=None,
                                                    related_name="servidores_escolta_terrestre_related")
    fase_escolta_terrestre = models.CharField(max_length=20, choices=FasesEscolta.choices, default=None, null=True, blank=True)
    pedidos_inclusao = models.ManyToManyField(PedidoInclusao,
                                              related_name="pedido_inclusao_related")
    tipo_aeronave = models.CharField(max_length=20, choices=TipoAeronave.choices, default=None, null=True, blank=True)
    instituicao = models.CharField(max_length=20, choices=Instituicao.choices, default=None, null=True, blank=True)
...
class VoosEscolta(models.Model):
    ...
    usuario_cadastro = models.ForeignKey(User, on_delete=models.PROTECT, 
                                         related_name="usuario_voo_escolta_related")
